...
void InitSystem(void)
{
    ...
    *((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x00;;
    ...
    while(i<18)
    {
		...
		(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*3)) + (0x4*0)))) = 0;
		(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*3)) + (0x4*1)))) = 0;	 
		(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*3)) + (0x4*2)))) = 0;
		(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*3)) + (0x4*3)))) = 0;
		(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*1)) + (0x4*8)))) = 0;

		(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*2)) + (0x4*0)))) = 0;	
		(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*2)) + (0x4*1)))) = 0;
		(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*2)) + (0x4*2)))) = 0;
		
		(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*2)) + (0x4*8)))) = 1;
		(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*2)) + (0x4*12)))) = 0;
		
    UART_Configuration();   
    TIMER_Configuration();  
		PWM_Configuration( 1000 , 25 );	
}
...
void TIMER_Configuration(void)
{
    ...
    DrvTIMER_Open(E_TMR0,2500,E_PERIODIC_MODE);  
...
{	
	...
	if((command[0] == 0xff)&&(command[1] == 0)&&(command[2] == 1))         
  {
		(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*2)) + (0x4*12)))) = 1;	
	}else if((command[0] == 0xff)&&(command[1] == 0)&&(command[2] == 0))   
	{  
		(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*2)) + (0x4*12)))) = 0;	
	}  
	
	if((command[0] == 0xff)&&(command[1] == 1)&&(command[2] == 0))       
	{
		PWM_Configuration( 1000 , command[3]*3/5 );   
	 
		
		if(command[3] <= 0x20)
		{
			(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*2)) + (0x4*0)))) = 1;	
			(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*2)) + (0x4*1)))) = 0;
			(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*2)) + (0x4*2)))) = 0;
		}
		...
		else if(command[3] > 0x30)
		{
			(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*2)) + (0x4*0)))) = 0;	
			(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*2)) + (0x4*1)))) = 0;
			(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*2)) + (0x4*2)))) = 1;
		}
  }

#line 272 "Smpl_NUTINY_120.c"
	
#line 305 "Smpl_NUTINY_120.c"
	
#line 353 "Smpl_NUTINY_120.c"

		
	(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*2)) + (0x4*8)))) = 0;
	delay_loop();
	delay_loop();
	delay_loop();
	delay_loop();
